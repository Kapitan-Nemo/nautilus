<div class="navbar container-fluid pt-5 p-relative">
    <a href="<?php echo get_home_url(); ?>">
        <img class="img-fluid navbar__logo" src="<?php echo get_template_directory_uri(); ?>/assets/dist/img/png/logo-koszalin-dla-dzieci.png" width="250" height="239" alt="Logo Koszalin Dla Dzieci" />
    </a>
    ...
    <div class="navbar__search">
        ...
        <form id="searchform" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>" autocomplete="off">
            <input type="text" name="s" placeholder="Wpisz czego szukasz..." class="navbar__search__input ajax-search" >
