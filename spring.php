<?php
/*
Template Name: Wiosna
Template Post Type: page
*/
?>
<?php get_header(); ?>
<main id="swup" class="transition-fade tiles spring">
    ...
    <div class="container-fluid">	
        <div class="tiles__wrapper">
            ...
            <img class="img-fluid tiles__featured" src="<?php echo get_template_directory_uri(); ?>/assets/dist/img/png/wiosna.png" width="" height="200" alt="Wiosna w Koszalinie" />
        </div>
        <div class="row justify-content-between mt-5">
            <?php if( have_rows('wiosna_kafelki', 'option')): $i = 0; ?>
                <?php while( have_rows('wiosna_kafelki','option') ): $i++; the_row(); ?>
