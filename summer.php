...
?>
<?php get_header(); ?>
<main id="swup" class="transition-fade tiles summer">
    ...
    <div class="container-fluid">	
        <div class="tiles__wrapper">
            ...
            <img class="img-fluid tiles__featured" src="<?php echo get_template_directory_uri(); ?>/assets/dist/img/png/lato.png" width="" height="200" alt="Lato w Koszalinie" />
        </div>
        <div class="row justify-content-between mt-5">
            <?php if( have_rows('lato_kafelki', 'option')): $i = 0; ?>
                <?php while( have_rows('lato_kafelki','option') ): $i++; the_row(); ?>
