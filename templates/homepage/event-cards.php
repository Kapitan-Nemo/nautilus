<section class="event-cards">
    <div class="container-fluid d-flex align-items-center">
        <h2 class="">Co robić w Koszalinie?</h2>
        <div class="row">
          <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xxl-3 mb-5 mb-xl-0">
              <div class="event-cards__card">
                  ...
                  <div class="event-cards__body">
                      <a href="">
                        <h3 class="text-center">Wiosną</h3>
                      </a>
                  </div>
              </div>
          </div>
          ...
          <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xxl-3 mb-5 mb-xl-0">
              <div class="event-cards__card">
                  ...
                  <div class="event-cards__body">
                      <a href="">
                        <h3 class="text-center">Jesienią</h3>
                      </a>
                  </div>
              </div>
          </div>
