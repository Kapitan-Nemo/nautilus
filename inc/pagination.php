<?php function misha_paginator( $first_page_url ){
 ...
 if ($current_page != 1)
     $pagination.= '<a href="'. $first_page_url . '/page/' . ($current_page-1) . $search_query . '" class="prev page-numbers"><i class="icon icon-chevron-left"></i></a>';
 ...
 if ($current_page != $last_link_in_the_middle )
     $pagination.= '<a href="'. $first_page_url . '/page/' . ($current_page+1) . $search_query .'" class="next page-numbers"><i class="icon icon-chevron-right"></i></a>';
